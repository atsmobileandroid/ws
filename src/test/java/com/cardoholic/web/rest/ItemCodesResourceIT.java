...
public class ItemCodesResourceIT {
    ...
    public void createItemCodes() throws Exception {
        ...
        ItemCodesDTO itemCodesDTO = itemCodesMapper.toDto(itemCodes);
        restItemCodesMockMvc.perform(post("/api/item-codes")
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(itemCodesDTO)))
    ...
    public void updateItemCodes() throws Exception {
        ...
        updatedItemCodes
            .code(UPDATED_CODE);
        ItemCodesDTO itemCodesDTO = itemCodesMapper.toDto(updatedItemCodes);
