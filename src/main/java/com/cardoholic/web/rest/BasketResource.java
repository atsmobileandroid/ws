...
/**
 * REST controller for managing {@link com.cardoholic.domain.Basket}.
 */
@RestController
@RequestMapping("/api")
public class BasketResource {
     ...
     */
    @PostMapping("/baskets")
    public ResponseEntity<BasketDTO> createBasket(@RequestBody BasketDTO basketDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/baskets")
    public ResponseEntity<BasketDTO> updateBasket(@RequestBody BasketDTO basketDTO) throws URISyntaxException {
